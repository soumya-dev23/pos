                ...
                <div class="col-md-8">
                    <form action="{{isset($product) ? route('products.update', $product['id']) : route('products.store')}}" method="post" novalidate="novalidate" id="productForm" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control select2_select select2-hidden-accessible" name="category_id" id="category_id">
                                    ...
                                    @foreach($categories as $cat)
                                        ...
                                        <option value="{{$cat['id']}}" {{ $cat['id'] == isset($product['category_id']) ? 'selected' : '' }}>{{$cat['category_name']}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group required row" style="display: none;">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control {{\App\Utils\AppUtils::inputFieldError($errors, 'sale_price')}}" name="sale_price" value="0" id="sale_price" type="number" placeholder="Sale Price">
