...
Route::group(['middleware' => ['user']], function () {
    ...
    Route::prefix('products')->group(function (){
        ...
        Route::get('/stock/{product}', 'ProductController@stock')->name('products.stock');
        Route::post('/stock-save', 'ProductController@stockSave')->name('products.stock-save');
        Route::post('/order-save', 'ProductController@orderSave')->name('products.order-save');
    });
